...
The original SIMULA 67 COMMON BASE DEFINITION appeared in June 1967. See here for more information: https://web.archive.org/web/20200219022748/http://www.simula67.info/

Just as C++ is based on C, Simula is an extension of Algol 60. Accordingly I have extended my Algol 60 parser (see https://github.com/rochus-keller/Algol60) with the syntax elements from the Common Base Language report ([1970 edition](https://web.archive.org/web/20200929104451/http://simula67.at.ifi.uio.no/Standard-70/Simula-1970-NR-22.pdf)). Meanwhile I also added the elements introduced in the Common Base Language 1975 and 1984 (TBD); there are the precompiler options SIM75 and SIM86 to enable and disable the elements.  

The lexer/parser works and successfully parses e.g. the DEMOS package (CBL70 compatible, see [this copy](./testcases/CBL70/DEMOS), the original is unfortunately no longer available) and the PC-Simula TestBatch (CLB84 compatible, see https://github.com/portablesimula/TestBatch).
